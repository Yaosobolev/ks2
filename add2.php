...
//	{	
	...
	echo "<H3 style=\"margin-left: 5em;\"> Вопросы для тестирования.</H3>";
	 ...
	 echo "<br><H4 align=Left> Заполните таблицу для $num_rows вопросов.</H4>";
	 echo "<form id=\"Reda\" >";
	  ...
	  for($i = 0; $i < $num_rows; $i++)
	  {
		...
		echo "<tr><td><textarea id=\"Que\" type=\"text\" rows=\"10\"></textarea></td><td><input id=\"Cod\" type=\"text\"></td><td><textarea id=\"V1\" type=\"text\" rows=\"10\"></textarea></td><td><textarea id=\"V2\" type=\"text\" rows=\"10\"></textarea></td><td><textarea id=\"V3\" type=\"text\" rows=\"10\"></textarea></td><td><textarea id=\"V4\" type=\"text\" rows=\"10\"></textarea></td><td><textarea id=\"V5\" type=\"text\" rows=\"10\"></textarea></td><td><input id=\"Gl\" type=\"text\"></td></tr>\n";
	  }
	...
	if(!isset($_GET["print"]))
	{  
		echo "<a style=\"float: left;\" href=\"teacher.php\"> Назад</a>";
