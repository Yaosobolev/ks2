...
WHERE    Groups.id= TestingResult.GroupID
	...
	{	
	 // $num_rows = mysql_num_rows($result);
	   $num_rows = mysql_num_rows($result);
	  if(isset($_GET["print"]))
	echo "<H3 style=\"margin-left: 5em;\"> Отчет o результатах тестирования.</H3>";
	else	  
	  echo "<br><H4 align=left>Результаты тестирования.</H4>";
	...
	{  
		...
		echo "<a style=\"float: right;margin-right: 10px;\"  href=\"All.php\" target=blank> Версия для печати </a>";	
	}
?>
</html>
</head>
