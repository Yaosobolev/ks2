...
begin
	InputQuery('Ввод значения', 'Укажите имя:', FFloor.FloorName);
  Caption:= FFloor.FloorName;
...
begin
    ...
    InputQuery('Ввод значения', 'Укажите шаг сетки', s);
...
begin
  ...
  s:= 
  'Топология: звезда'+#10#13+
  'коммутаторов '		+IntToStr(flr.Switches)+#10#13+
  'рабочих станций '+IntToStr(flr.WStations)+#10#13+
  'серверов '	 			+IntToStr(flr.Servers);
