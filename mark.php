...
<?php
  ...
  mysql_select_db("Fortest");
	...
	WHERE mark =\"$_GET[mark_id]\" and Groups.id= TestingResult.GroupID
	...
	{	
	 // $num_rows = mysql_num_rows($result);
	   $num_rows = mysql_num_rows($result);
	  if(isset($_GET["print"]))
	echo "<H3 style=\"margin-left: 5em;\"> Отчет o результатах тестирования по выбранной оценке.</H3>";
	else	  
	  echo "<br><H4 align=left>Результаты тестирования по выбранной оценке.</H4>";
	...
	{  
		...
		echo "<a style=\"float: right;margin-right: 10px;\"  href=\"mark.php?mark_id=$_GET[mark_id]&print=1\" target=blank> Версия для печати </a>";	
	}
?>
</html>
</head>
