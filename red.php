 ...
 include "connect.php";
  ...
  /*  $query = "SELECT COUNT(Number) FROM Questions";
	...
	echo "<H3 style=\"margin-left: 5em;\"> Вопросы для тестирования.</H3>";
	 ...
	 echo "<form name=\"Add\" method=\"POST\" action=\"add.php\">";
	 echo "Добавление нового вопроса: ";
//	 echo "<input name=\"Kol\" type=\"text\">";
	 echo "  <input type=\"submit\" type=submit value=\"Добавить\">";
	  echo "</form>";	 
